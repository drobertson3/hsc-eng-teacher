...
const BADGES = [
  ...
  {id:'ops_master',  emoji:'🏗️', name:'Structures Master',  desc:'85%+ accuracy over 25+ Civil Structures questions'},
  {id:'mkt_master',  emoji:'🚗', name:'Transport Expert', desc:'85%+ accuracy over 25+ Personal & Public Transport questions'},
  {id:'fin_master',  emoji:'✈️', name:'Aeronautical Analyst',    desc:'85%+ accuracy over 25+ Aeronautical Engineering questions'},
  {id:'hr_master',   emoji:'📡', name:'Telecom Master',     desc:'85%+ accuracy over 25+ Telecommunications Engineering questions'},
...
function evaluateBadges(student, attempt, totalQuestions){
  ...
  const checks = {
    ...
    ops_master:() => topicAcc('Civil Structures') >= 0.85,
    mkt_master:() => topicAcc('Personal & Public Transport') >= 0.85,
    fin_master:() => topicAcc('Aeronautical Engineering') >= 0.85,
    hr_master: () => topicAcc('Telecommunications Engineering') >= 0.85,
    ...
    all_rounder:() => ['Civil Structures','Personal & Public Transport','Aeronautical Engineering','Telecommunications Engineering','Engineering Fundamentals']
